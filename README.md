...
- [Leaderboard](https://tshobohwa.github.io/leaderboard/dist/)
...
```sh
- npm install i webpack wepack-cli --save-dev
- npm run start
```
...
```sh
  cd my-folder
  git clone https://github.com/Tshobohwa/leaderboard.git
```
...
- [ Add score ] **[Add score]**
- [ refrech score table ] **[Refrech score table]**
...
Feel free to check the [issues page](https://github.com/Tshobohwa/leaderboard/issues).
...
I would like to thank Microverse for the oportunity to learn they gave to me.
