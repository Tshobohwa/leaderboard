...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _modules_DOM_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/DOM.js */ \"./src/modules/DOM.js\");\n/* harmony import */ var _modules_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/util.js */ \"./src/modules/util.js\");\n\n\n\n\n(0,_modules_util_js__WEBPACK_IMPORTED_MODULE_2__.refrechScoretable)();\n\n_modules_DOM_js__WEBPACK_IMPORTED_MODULE_1__.submitBtn.addEventListener('click', (e) => {\n  e.preventDefault();\n  (0,_modules_util_js__WEBPACK_IMPORTED_MODULE_2__.submitScore)();\n});\n\n_modules_DOM_js__WEBPACK_IMPORTED_MODULE_1__.refrechBtn.addEventListener('click', _modules_util_js__WEBPACK_IMPORTED_MODULE_2__.refrechScoretable);\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"refrechScoretable\": () => (/* binding */ refrechScoretable),\n/* harmony export */   \"submitScore\": () => (/* binding */ submitScore)\n/* harmony export */ });\n/* harmony import */ var _DOM_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DOM.js */ \"./src/modules/DOM.js\");\n\n\nconst gameUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/0b3IROaa6TNhBfSLZFnF/scores';\n\nconst submitScore = async () => {\n  try {\n    _DOM_js__WEBPACK_IMPORTED_MODULE_0__.postErrorContainer.innerHTML = '';\n    const response = await fetch(gameUrl, {\n      method: 'POST',\n      headers: {\n        'Content-Type': 'application/json',\n      },\n      body: JSON.stringify({\n        user: _DOM_js__WEBPACK_IMPORTED_MODULE_0__.nameInput.value,\n        score: _DOM_js__WEBPACK_IMPORTED_MODULE_0__.scoreInput.value,\n      }),\n    });\n    if (!response.ok) throw new Error(`Enable to post your score (status: ${response.status})`);\n    _DOM_js__WEBPACK_IMPORTED_MODULE_0__.nameInput.value = '';\n    _DOM_js__WEBPACK_IMPORTED_MODULE_0__.scoreInput.value = '';\n  } catch (err) {\n    (0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.throwPostError)(err.message);\n  }\n};\n\nconst refrechScoretable = async () => {\n  try {\n    const response = await fetch(gameUrl);\n    if (!response.ok) {\n      throw new Error(\n        `Enable to access your score table (status: ${response.status})`,\n      );\n    }\n    const data = await response.json();\n    const scores = data.result;\n    if (!scores.length) throw new Error('The score table is empty');\n    (0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.renderScores)(scores);\n  } catch (err) {\n    (0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.throwGetError)(err.message);\n  }\n};\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/util.js?");
